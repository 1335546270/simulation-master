...
import com.iqilu.enums.common.FileEnum;
...
public class EasyPoiUtils {
    ...
    private static void downLoadExcel(String fileName, HttpServletResponse response, Workbook workbook) throws IOException {
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(fileName + "." + FileEnum.XLSX.getValue(), "UTF-8"));
